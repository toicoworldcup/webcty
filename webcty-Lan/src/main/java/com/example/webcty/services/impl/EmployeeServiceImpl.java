...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Override
    public Employee getEmployeeByEmcode(String id) {
        // Trả về null nếu không tìm thấy hoặc có thể ném ngoại lệ
        return employeeRepository.findByEmcode(id).orElseThrow(() -> new RuntimeException("Employee not found"));
    }
    ...
    public Employee updateEmployee(String id, Employee updatedEmployee) {
        ...
        Employee employee = getEmployeeByEmcode(id);
